...
#### Producing Reader-friendly table and visualization
...
```
    ...
    ## Picking joint bandwidth of 8.05
...
```
    ...
    ## 
    ## $title
    ## [1] "Age distribution by education and gender"
    ## 
    ## attr(,"class")
    ## [1] "labels"
...
```
    ...
    ## # A tibble: 231 × 1,446
    ##     seqn sex      age bmi   education     total_activity  min1  min2  min3  min4
    ##    <dbl> <fct>  <dbl> <chr> <fct>                  <dbl> <dbl> <dbl> <dbl> <dbl>
    ##  1 62161 Male      22 23.3  High school …         13194. 1.11  3.12  1.47  0.938
    ##  2 62164 Female    44 23.2  More than hi…         13411. 1.92  1.67  2.38  0.935
    ##  3 62169 Male      21 20.1  High school …          9991. 5.85  5.18  4.76  6.48 
    ##  4 62174 Male      80 33.9  More than hi…          8579. 5.42  3.48  3.72  3.81 
    ##  5 62177 Male      51 20.1  High school …         11918. 6.14  8.06  9.99  6.60 
    ##  6 62178 Male      80 28.5  High school …          7489. 0.167 0.429 0.131 1.20 
    ##  7 62180 Male      35 27.9  More than hi…         14205. 0.039 0     0     0    
    ##  8 62184 Male      26 22.1  High school …         13599. 1.55  2.81  3.86  4.76 
    ##  9 62189 Female    30 22.4  More than hi…         18551. 2.81  0.195 0.163 0    
    ## 10 62191 Male      70 NA    High school …          7305. 2.84  2.44  2.36  1.87 
    ## # ℹ 221 more rows
